...
type ReplicatedJobApplyConfiguration struct {
	...
	Template *JobSpecApplyConfiguration `json:"template,omitempty"`
...
func (b *ReplicatedJobApplyConfiguration) WithTemplate(value *JobSpecApplyConfiguration) *ReplicatedJobApplyConfiguration {
	b.Template = value
	return b
}
