...
type StartupPolicyApplyConfiguration struct {
	StartupPolicyOrder *v1alpha1.StartupPolicyOptions `json:"startupPolicyOrder,omitempty"`
}
...
func (b *StartupPolicyApplyConfiguration) WithStartupPolicyOrder(value v1alpha1.StartupPolicyOptions) *StartupPolicyApplyConfiguration {
